...
func printUsage() {
	...
	fmt.Println("  --name <name>          Generate SDK for a specific named OpenAPI output")
	fmt.Println("  --output <path>        Override output directory for generated SDK")
	fmt.Println("  --config <path>        Path to tsgonest config file")
	fmt.Println()
	...
	fmt.Println("  tsgonest sdk                                # Generate SDK for all outputs")
	fmt.Println("  tsgonest sdk --name public                  # Generate SDK for 'public' output")
	fmt.Println("  tsgonest sdk --name public --output ./client # Custom output dir")
	fmt.Println()
}
